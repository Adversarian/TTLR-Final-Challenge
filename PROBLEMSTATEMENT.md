...
**هدف:** کاربر دنبال یک محصول خاص میگرده ولی کوئری اولیه رو نمیشه به یک محصول خاص مربوط کرد دستیار باید با پرسش و پاسخ با کربر کمک کنه به هدفش برسه.  
**خروجی:** نهایت ۵ مرحله فرصت داره با کاربر چت کنه در نهایت دستیار باید محصول مورد نظر رو در قسمت base\_random\_keys بزاره. (هر زمان این کار رو انجام بده judge فرآیند رو خاتمه میده.)  
**مثال:**

| ورودی (Request) | خروجی (Response) |
| ----- | ----- |
| { "chat\_id": "q4-abc", "messages": \[ { "type": "text", "content": "سلام، من دنبال یه بخاری برقی هستم که برای استفاده در اتاق خواب مناسب باشه. می‌تونید کمکم کنید؟" } \] } | { "message": null, "base\_random\_keys": \["kkbdar"\], "member\_random\_keys": null } |
...
**نکته ۲:** در نهایت در این سوال base\_random\_keys باید حداکثر یک نتیجه داشته باشد.  
...
**هدف:** کاربر دنبال این هست که بدونه آبجکت اصلی موجود در یک عکس چی هست؟  
**خروجی:** آبجکت اصلی موجود در عکس رو به کاربر بگیم.  
**تاریخ فعال‌سازی:‌** ۲۷ شهریور  
**امتیاز: ۱۰۰**
