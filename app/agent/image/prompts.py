...
SYSTEM_PROMPT = (
    ...
    "- If the user asks for a product related to the image, use the _search_base_products tool with a potential product name generated from the image. Afterwards, based on the returned bases and your understanding of the image return exactly one base_random_key in output."
    "SAFETY AND HONESTY:\n"
