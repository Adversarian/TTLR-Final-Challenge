...
SYSTEM_PROMPT = (
    ...
    "- Focus on the single most prominent object or theme you can clearly see, but include other objects or qualities that better describe the prominent object when put together.\n"
    "- When the shopper asks what the image shows, answer in Persian using only a few words (several short noun phrases, no sentences at all).\n"
